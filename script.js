...
printBookInfo({ title: 'Kababa', author: 'Robert Sedgewick', year: '2011' });
// const ingredients = [
//   prompt('first ingredient?'),
//   prompt('second ingredient?'),
//   prompt('third ingredient?'),
// ];
// const meals = function(ing1, ing2, ing3){
//   alert(`your meal is made of ${ing1}, ${ing2}, and ${ing3}.`);
...
const hasExamplesInJava = function (book) {
  ...
  console.log(book.programmingLanguage, javaAvailable);
};
...
//question 2
const [gk, ...outfielplayers] = game.players[0];
const players1 = [gk, outfielplayers];
